  ...
  return (
    <section id="register" className="py-24 md:py-36 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-8 p-8 rounded-lg border border-border bg-bg-card flex flex-col items-center text-center">
          ...
          <p className="text-sm text-text-secondary mb-6 max-w-md">
            We are no longer accepting new team registrations. Follow the competition
            as our registered teams proceed to the online qualifier.
          </p>
          <a
